...
fn hook_event_label(event_name: codex_protocol::protocol::HookEventName) -> &'static str {
    match event_name {
        ...
        codex_protocol::protocol::HookEventName::SessionResume => "SessionResume",
        codex_protocol::protocol::HookEventName::SessionEnd => "SessionEnd",
        codex_protocol::protocol::HookEventName::SessionInterrupted => "SessionInterrupted",
        codex_protocol::protocol::HookEventName::UserPromptSubmit => "UserPromptSubmit",
        codex_protocol::protocol::HookEventName::TurnStart => "TurnStart",
        codex_protocol::protocol::HookEventName::TurnComplete => "TurnComplete",
        codex_protocol::protocol::HookEventName::TurnAbort => "TurnAbort",
        codex_protocol::protocol::HookEventName::TurnError => "TurnError",
        codex_protocol::protocol::HookEventName::PreToolUse => "PreToolUse",
        codex_protocol::protocol::HookEventName::PostToolUse => "PostToolUse",
        codex_protocol::protocol::HookEventName::ToolError => "ToolError",
        codex_protocol::protocol::HookEventName::PermissionRequest => "PermissionRequest",
        codex_protocol::protocol::HookEventName::PermissionDenied => "PermissionDenied",
        codex_protocol::protocol::HookEventName::ApprovalGranted => "ApprovalGranted",
        codex_protocol::protocol::HookEventName::TaskCreated => "TaskCreated",
        codex_protocol::protocol::HookEventName::TaskStarted => "TaskStarted",
        codex_protocol::protocol::HookEventName::TaskCompleted => "TaskCompleted",
        codex_protocol::protocol::HookEventName::TaskFailed => "TaskFailed",
        codex_protocol::protocol::HookEventName::SubagentStart => "SubagentStart",
        codex_protocol::protocol::HookEventName::SubagentComplete => "SubagentComplete",
        codex_protocol::protocol::HookEventName::SubagentEscalation => "SubagentEscalation",
        codex_protocol::protocol::HookEventName::FileChanged => "FileChanged",
        codex_protocol::protocol::HookEventName::CwdChanged => "CwdChanged",
        codex_protocol::protocol::HookEventName::ConfigChanged => "ConfigChanged",
        codex_protocol::protocol::HookEventName::MemoryUpdated => "MemoryUpdated",
        codex_protocol::protocol::HookEventName::SkillChanged => "SkillChanged",
        codex_protocol::protocol::HookEventName::CompactionStart => "CompactionStart",
        codex_protocol::protocol::HookEventName::CompactionComplete => "CompactionComplete",
        codex_protocol::protocol::HookEventName::ContextTruncated => "ContextTruncated",
        codex_protocol::protocol::HookEventName::PromptCacheHit => "PromptCacheHit",
        codex_protocol::protocol::HookEventName::PromptCacheMiss => "PromptCacheMiss",

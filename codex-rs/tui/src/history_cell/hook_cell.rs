...
fn hook_event_label(event_name: HookEventName) -> &'static str {
    match event_name {
        ...
        HookEventName::SessionResume => "SessionResume",
        HookEventName::SessionEnd => "SessionEnd",
        HookEventName::SessionInterrupted => "SessionInterrupted",
        HookEventName::UserPromptSubmit => "UserPromptSubmit",
        HookEventName::TurnStart => "TurnStart",
        HookEventName::TurnComplete => "TurnComplete",
        HookEventName::TurnAbort => "TurnAbort",
        HookEventName::TurnError => "TurnError",
        HookEventName::PreToolUse => "PreToolUse",
        HookEventName::PostToolUse => "PostToolUse",
        HookEventName::ToolError => "ToolError",
        HookEventName::PermissionRequest => "PermissionRequest",
        HookEventName::PermissionDenied => "PermissionDenied",
        HookEventName::ApprovalGranted => "ApprovalGranted",
        HookEventName::TaskCreated => "TaskCreated",
        HookEventName::TaskStarted => "TaskStarted",
        HookEventName::TaskCompleted => "TaskCompleted",
        HookEventName::TaskFailed => "TaskFailed",
        HookEventName::SubagentStart => "SubagentStart",
        HookEventName::SubagentComplete => "SubagentComplete",
        HookEventName::SubagentEscalation => "SubagentEscalation",
        HookEventName::FileChanged => "FileChanged",
        HookEventName::CwdChanged => "CwdChanged",
        HookEventName::ConfigChanged => "ConfigChanged",
        HookEventName::MemoryUpdated => "MemoryUpdated",
        HookEventName::SkillChanged => "SkillChanged",
        HookEventName::CompactionStart => "CompactionStart",
        HookEventName::CompactionComplete => "CompactionComplete",
        HookEventName::ContextTruncated => "ContextTruncated",
        HookEventName::PromptCacheHit => "PromptCacheHit",
        HookEventName::PromptCacheMiss => "PromptCacheMiss",
